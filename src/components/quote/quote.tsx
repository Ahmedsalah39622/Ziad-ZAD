...
export function Quote() {
  return (
    <section className="w-full bg-background text-foreground py-24 md:py-32 px-6 overflow-hidden relative">
      <div className="absolute top-0 left-0 w-full h-full opacity-25 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[20vw] font-black whitespace-nowrap text-foreground/[0.03] select-none">
          ZAD
        </div>
      </div>
