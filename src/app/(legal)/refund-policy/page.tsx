  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
      ...
      <div className="space-y-8 text-neutral-600 text-sm leading-relaxed">
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">1. Return Window</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">2. Eligible Items</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">3. How to Initiate a Return</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">4. Refund Process</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">5. Exchanges</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">6. Damaged or Defective Items</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">7. Return Shipping</h2>
          <p>
