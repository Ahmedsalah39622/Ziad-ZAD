  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
      ...
      <div className="space-y-8 text-neutral-600 text-sm leading-relaxed">
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">1. Information We Collect</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">2. How We Use Your Information</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">3. Data Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">4. Cookies</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">5. Third-Party Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">6. Your Rights</h2>
          <p>
        ...
        <section>
          <h2 className="text-foreground font-bold text-lg uppercase tracking-wider mb-3">7. Changes to This Policy</h2>
          <p>
