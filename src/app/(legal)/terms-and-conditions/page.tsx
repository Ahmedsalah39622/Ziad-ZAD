  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
      ...
      <div className="space-y-8 text-neutral-400 text-sm leading-relaxed">
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">1. Overview</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">2. Products &amp; Pricing</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">3. Orders &amp; Payment</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">4. Shipping &amp; Delivery</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">5. Intellectual Property</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">6. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-bold text-lg uppercase tracking-wider mb-3">7. Changes to Terms</h2>
          <p>
