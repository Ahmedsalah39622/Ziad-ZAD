        ...
        return (
            <div className="bg-background min-h-screen text-foreground flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6 pt-20">
                    ...
                    <Link href="/shop" className="bg-primary text-primary-foreground px-8 h-12 flex items-center font-bold tracking-widest uppercase text-xs hover:opacity-90 transition-colors">
                        Browse Collection
                    </Link>
                </div>
            </div>
        ...
        return (
            <div className="bg-background min-h-screen text-foreground flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center gap-6 pt-20 px-6">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-center text-foreground">Order Confirmed</h1>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-4">
                                    <input
                                        ...
                                        className="bg-transparent border border-border h-12 px-4 text-sm focus:outline-none focus:border-foreground transition-colors placeholder:text-muted-foreground"
                                    />
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-3">
                                    <button
                                        ...
                                        className={`flex items-center gap-4 border h-14 px-5 transition-all duration-200 ${form.paymentMethod === "cod" ? "border-foreground bg-foreground/5" : "border-border hover:border-foreground/30"
                                            }`}
                                    >
                                        <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${form.paymentMethod === "cod" ? "border-foreground" : "border-muted-foreground"}`}>
                                            {form.paymentMethod === "cod" && <div className="w-2 h-2 rounded-full bg-foreground" />}
                                        </div>
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-4 border h-14 px-5 transition-all duration-200 ${form.paymentMethod === "card" ? "border-foreground bg-foreground/5" : "border-border hover:border-foreground/30"
                                            }`}
                                    >
                                        <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${form.paymentMethod === "card" ? "border-foreground" : "border-muted-foreground"}`}>
                                            {form.paymentMethod === "card" && <div className="w-2 h-2 rounded-full bg-foreground" />}
                                        </div>
                        ...
                        <div className="lg:col-span-2">
                            <div className="sticky top-28 bg-card border border-border p-6 md:p-8">
                                <h2 className="text-xs font-bold tracking-[0.2em] uppercase text-muted-foreground mb-6">
                                    Order Summary
                                </h2>
                                ...
                                <div className="divide-y divide-border">
                                    {items.map((item) => (
                                        <div key={`${item.product.id}-${item.size}-${item.color}`} className="flex gap-4 py-4">
                                            <div className="w-16 h-20 bg-background relative shrink-0 overflow-hidden">
                                                {item.product.image ? (
                                                    <Image src={item.product.image} alt={item.product.name} fill className="object-contain p-2" />
                                                ) : (
                                                    <div className="w-full h-full flex items-center justify-center text-muted-foreground text-[8px] font-bold uppercase">
                                                        {item.product.name}
                                                    </div>
                                                )}
                                            </div>
                                ...
                                <div className="border-t border-border mt-4 pt-4 flex flex-col gap-3">
                                    ...
                                    {shipping === 0 && (
                                        <p className="text-foreground font-bold text-xs uppercase tracking-wider">Free shipping on orders over L.E 1,000</p>
                                    )}
                                ...
                                <p className="text-muted-foreground/60 text-[10px] text-center mt-4 tracking-wider">
