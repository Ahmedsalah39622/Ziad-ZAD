    ...
    return (
        <div className="relative min-h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-black text-white font-inter">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute bottom-0 right-0 w-[300px] h-[300px] bg-gradient-radial from-cyan-500/5 to-transparent rounded-full blur-3xl" />
                <div className="absolute top-0 left-0 w-[300px] h-[300px] bg-gradient-radial from-purple-500/5 to-transparent rounded-full blur-2xl opacity-50" />
            </div>
